@echo off
REM ============================================================
REM  Bush Legacy Builders — Claude GitHub Push Template
REM  Copy this file into each new project folder.
REM  Update the variables below for the new project.
REM ============================================================

REM ---- CONFIGURE THESE FOR EACH PROJECT ----
SET GH_TOKEN=ghp_YOUR_TOKEN_HERE
SET GH_USER=Jbickish7464
SET REPO=Cowork-projects
SET BRANCH=main
SET PROJECT_PATH=bush-legacy\YOUR-PROJECT-NAME-HERE
REM ------------------------------------------
